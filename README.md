...
## Table of Content:
  ...
  * [N-Balls Generation:](#n-balls-generation-)
    + [Input:](#input-)
    + [Output:](#output-)
  ...
  * [Reducing Dimensionality:](#reducing-dimensionality-)
    ...
    + [Console output explained:](#console-output-explained-)
  * [Visualization](#visualization)
    + [Visualization options explanation:](#visualization-options-explanation-)
